...
const projectsData = [
  {
    id: 1,
    title: "Move with Aman - Studio Platform & CMS",
    description: "Studio Management, Events, CMS & WhatsApp Leads",
    imageUrl: "/images/mwa.png",
    overlayTitle: "Move with Aman",
    overlayDescription: "Studio operations platform with custom content editing, payment gateway, event management, and WhatsApp lead integration.",
    technologies: ["Next.js", "Payment Gateway", "WhatsApp API", "Tailwind CSS"],
    liveLink: "https://movewithaman.co.in/",
    githubLink: "#",
  },
  {
    id: 2,
